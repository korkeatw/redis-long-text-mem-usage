...
> **Update** This experiment used Redis default config. It's not suit for this data, 
zip (compression) feature doesn't be used in this case. I changed values of `hash-max-ziplist-entries` 
